    ...
    <div class="space-y-4">
        <?php if (empty($opportunities)): ?>
            <div class="bg-white p-12 rounded-3xl border border-slate-200/90 shadow-card text-center space-y-3">
                ...
                <h3 class="font-bold text-sm text-slate-800">No Open Opportunities Available Right Now</h3>
                <p class="text-xs text-slate-500 max-w-md mx-auto">
                    New academic and corporate training requirements from universities across India are published frequently. Check back soon or ensure your skill stack is up to date.
                </p>
                <div class="pt-2">
