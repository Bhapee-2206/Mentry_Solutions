...
if ($targetOpp) {
    ...
    $autoOpenOppData = [
        ...
        'travelCovered' => array_key_exists('travelCovered', (array)$targetOpp) ? filter_var($targetOpp['travelCovered'], FILTER_VALIDATE_BOOLEAN) : (($targetOpp['mode'] ?? '') !== 'ONLINE'),
        'accommodationCovered' => array_key_exists('accommodationCovered', (array)$targetOpp) ? filter_var($targetOpp['accommodationCovered'], FILTER_VALIDATE_BOOLEAN) : (($targetOpp['mode'] ?? '') !== 'ONLINE'),
        'diningCovered' => array_key_exists('diningCovered', (array)$targetOpp) ? filter_var($targetOpp['diningCovered'], FILTER_VALIDATE_BOOLEAN) : (($targetOpp['mode'] ?? '') !== 'ONLINE'),
        ...
        <?php else: ?>
            <?php foreach ($opportunities as $opp): 
                ...
                $oppDataJson = htmlspecialchars(json_encode([
                    ...
                    'travelCovered' => array_key_exists('travelCovered', (array)$opp) ? filter_var($opp['travelCovered'], FILTER_VALIDATE_BOOLEAN) : (($opp['mode'] ?? '') !== 'ONLINE'),
                    'accommodationCovered' => array_key_exists('accommodationCovered', (array)$opp) ? filter_var($opp['accommodationCovered'], FILTER_VALIDATE_BOOLEAN) : (($opp['mode'] ?? '') !== 'ONLINE'),
                    'diningCovered' => array_key_exists('diningCovered', (array)$opp) ? filter_var($opp['diningCovered'], FILTER_VALIDATE_BOOLEAN) : (($opp['mode'] ?? '') !== 'ONLINE'),
