...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    ...
    die("Method Not Allowed: POST method required.");
}
...
$redirect = $_POST['return_url'] ?? $_SERVER['HTTP_REFERER'] ?? '/admin/settings.php';
// Validate redirect is a safe internal relative path
