...
<div id="mentryGlobalLoader" class="fixed inset-0 z-[99999] bg-slate-950/85 backdrop-blur-md flex flex-col items-center justify-center transition-opacity duration-300 opacity-100 pointer-events-auto select-none" style="display: flex;">
    <div class="relative flex flex-col items-center justify-center space-y-5 px-6 text-center">
        ...
        <div class="relative flex items-center justify-center">
            ...
            <div class="absolute w-28 h-28 rounded-full bg-[#FE5E04]/25 blur-xl animate-pulse"></div>
            
            <!-- Rotating gradient spinner border -->
            <div class="w-20 h-20 rounded-2xl p-[2.5px] bg-gradient-to-tr from-[#FE5E04] via-amber-400 to-transparent animate-spin">
                <div class="w-full h-full bg-slate-950 rounded-[13px]"></div>
            </div>

            <!-- Central Brand Logo -->
            <div class="absolute inset-0 m-auto w-14 h-14 bg-white rounded-xl shadow-xl p-2 flex items-center justify-center overflow-hidden border border-slate-200">
        ...
        <div class="w-40 h-1.5 bg-slate-900 rounded-full overflow-hidden border border-slate-800">
            <div class="h-full bg-gradient-to-r from-[#FE5E04] via-amber-400 to-[#FE5E04] rounded-full w-2/3 animate-[mentryLoaderBar_1.2s_ease-in-out_infinite]"></div>
        </div>
    </div>
</div>
